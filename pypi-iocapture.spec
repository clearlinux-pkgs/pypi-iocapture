...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672282061
...
cp %{_builddir}/iocapture-%{version}/COPYING %{buildroot}/usr/share/package-licenses/pypi-iocapture/01a6b4bf79aca9b556822601186afab86e8c4fbf || :
cp %{_builddir}/iocapture-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/pypi-iocapture/87d781b3a23bd13eef4b827bed888c9176d762d1 || :
